...
Процедура ПроверитьРавенствоТабличныхДокументовПоОформлению(ТабДок1, ТабДок2,
	УчитыватьТолькоВидимыеКолонкиИлиДопСообщениеОшибки = Ложь, УчитыватьТолькоВидимыеСтрокиИлиДопСообщениеОшибки = Ложь,
	Знач ДопСообщениеОшибки = "", Знач ДопПараметры = Неопределено) Экспорт
	...
	ЭлементыОформления.Добавить("РазмещениеТекста");
	ЭлементыОформления.Добавить("ЦветФона");
	ЭлементыОформления.Добавить("ЦветТекста");
	ЭлементыОформления.Добавить("Шрифт.Имя");
	ЭлементыОформления.Добавить("Шрифт.Размер");
	ЭлементыОформления.Добавить("Шрифт.Наклонный");
	ЭлементыОформления.Добавить("Шрифт.Полужирный");
	ЭлементыОформления.Добавить("Шрифт.Полужирный");
	ЭлементыОформления.Добавить("Шрифт.Подчеркивание");
	ЭлементыОформления.Добавить("Шрифт.Зачеркивание");
	
	Для Каждого ЭлементОформления Из ЭлементыОформления Цикл
		
		Таб1 = ПолучитьТаблицуЗначенийИзТабличногоДокументаСОформлением(ТабДок1, УчитыватьТолькоВидимыеКолонки, УчитыватьТолькоВидимыеСтроки, ЭлементОформления);
		Таб2 = ПолучитьТаблицуЗначенийИзТабличногоДокументаСОформлением(ТабДок2, УчитыватьТолькоВидимыеКолонки, УчитыватьТолькоВидимыеСтроки, ЭлементОформления);
...
Функция ПолучитьТаблицуЗначенийИзТабличногоДокументаСОформлением(ТабличныйДокумент, УчитыватьТолькоВидимыеКолонки = Ложь, УчитыватьТолькоВидимыеСтроки = Ложь,
		Знач ЭлементОформления) Экспорт
...
Функция ЗначениеСРазделителем(СоставноеЗначение)
	Возврат СоставноеЗначение + ?(СоставноеЗначение = "","","_");	
КонецФункции
